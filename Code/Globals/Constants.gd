...
#--------------------------------------
#region TEXT
const condition_power_text: String = " This power can't be used if [name] is affected by a Special Condition."
...
#--------------------------------------
#region SCENES
var playing_button: PackedScene = load("res://Scenes/UI/Lists/play_button.tscn")
...
const fossil_card: PackedScene = preload("res://Scenes/UI/CardDisplay/fossil_card.tscn")
